...
class SimpleModbusRTUClient:
    """
    Async Modbus RTU client for reading telemetry and writing commands
    over a serial port. Same interface as SimpleModbusClient (TCP).

    Requires a virtual serial pair (e.g. via socat) or physical hardware.
    """

    def __init__(self, serial_port: str, unit_id: int, register_map_path: str,
